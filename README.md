...
This is a small guide to use the macros contained in the SSC_test folder.
For the python specific requirements take a look at Blazar_model/README.md

The SSC_test.py is  a python macro to test the ssc_model class whose definition is ontained in the ssc_model folder
